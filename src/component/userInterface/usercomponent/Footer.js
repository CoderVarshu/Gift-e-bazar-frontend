    ...
    return (
        <div>
                        ...
                        <Accordion style={{ background:'#f5f5f5'}}>
                            ...
                            <AccordionDetails>
                                <Typography>
                                    ...
                                    <div className={classes.ship2}> Terms of Services</div>
                                    <div className={classes.ship2}> Refund Policy</div>
                                    <div className={classes.ship2}> Sell on Gift-e-bazar </div>
                                </Typography>
                            </AccordionDetails>
                        </Accordion>
                        <Accordion style={{ background:'#f5f5f5'}}>
            ...
            <div
                ...
                >
                Gift-e-bazar is an incorporated  business with Government of India
                </div>
                <div style={{
                    display: 'flex',
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        2022 Gift-e-bazar All Right Reserved
