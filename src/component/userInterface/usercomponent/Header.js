                ...
                <Toolbar>
                    {!matches ? <>
                        ...
                        <div style={{ display: 'flex', marginRight: 15, fontFamily: 'Poppins', fontSize: 16 }}>
                            <EmailOutlinedIcon />   support@giftebazar.in</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', marginTop: !matches ? '3%' : '5%' }}>
            {!matches ? <>
                <div ><a href='/home'>
                    ...
                    <img src='/assets/gift-e-bazar.png' alt='image' style={{ width: 200, marginLeft: 70, marginTop: 25 }}
          ...
          <OutlinedInput onChange={(event) => {
             setSearch(event.target.value)
             navigate('/searchproduct',{state:{search:search}})
           }}
          ...
          />
                ...
                <div className={classes.searchbar} onClick={(event) => {
                    navigate('/searchproduct', { state: { search: search } })
                }} >
                ...
                <div >
                    <a href='/home'>
                        <img src='/assets/mygift.avif' alt='image' style={{ width: 160, marginLeft: matches_small ? 15 : matches ? '80%' : '', marginTop: matches_small ? 35 : matches ? 20 : 45, marginRight: 0 }} />
                    </a></div>
            </>}
