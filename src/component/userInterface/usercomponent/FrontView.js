    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', marginTop: '5%', width: '100%' }}>
        <div style={{ width: '40%', marginRight: '5%', marginLeft: '5%' }}>
          <img src="/product/cake slider/Hatke_Gifts_Static.webp" style={{ width: '100%', height:matches?150: 300 }} />
        </div>
        <div style={{ width: '40%' }}>
          <img src="/product/cake slider/Photo_Frame_Static.webp" style={{ width: '100%', height:matches?150: 300 }} />
        </div>
      </div>
      {/* <div style={{ display: 'flex', flexDirection: 'row', marginTop: '5%', width: '100%' }}>
        <div style={{ width: '40%', marginRight: '5%', marginLeft: '5%' }}>
          <img src="/product/cake slider/Hand_Lamp_Static.webp" style={{ width: '100%', height:matches?150: 300 }} />
        </div>
        <div style={{ width: '40%' }}>
          <img src="/product/cake slider/half banner.webp" style={{ width: '100%', height:matches?150: 300 }} />
        </div>
      </div> */}
      <div style={{ fontFamily: 'Poppins', fontSize: 28, marginLeft: '8%', marginTop: '5%' }}>
        Our categories
      </div>
      <ExploreCategory />
      <div>
        <img src="/product/goodness_hampers.webp"
          style={{ width: '100%', height:matches?150: 300, marginTop: 50, marginLeft: 0 }} />
        {/* {maincontainer()} */}
        <div style={{ fontFamily: 'Poppins', fontSize: 28, marginLeft: '8%', marginTop: '5%' }}>
          Our Deals Products
        </div>
