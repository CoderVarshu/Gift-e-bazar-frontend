...
import SearchBarWithSuggestion from './component/userInterface/SearchBarWithSuggestion';
import Searchproduct from './component/userInterface/screens/SerachProduct';
import Category from './component/userInterface/screens/Category';
      ...
      <Router>
        <Routes>
         ...
         <Route element= {<Products/>} path={'/products'} />
          ...
          <Route element ={<SearchBarWithSuggestion/>} path={"/searchbar"} />
          <Route element={<Searchproduct/>} path={"/searchproduct"} />
          <Route element={<Category/>} path={"/categorypage"}/>
        </Routes>
      </Router>    
    </div>
  );
